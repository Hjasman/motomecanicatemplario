    ...
    <form class="form-horizontal" action="{{route('productos.savep') }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" required  placeholder="Nombre" class="form-control text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" name="nombrep">
                </div>
            </div>
            <div class="form-group row">
              <label for="text" class="col-sm-4 col-form-label">Marca:</label>
              <div class="col-sm-6">
                  <input type="text" required placeholder="Marca" class="form-control text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" name="appatp">
              </div>
            </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <textarea class="form-control" placeholder="Descripcion general" class="form-control text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" style="height: 180px;"
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="number" placeholder="Precio" min="0" max="99999"  class="form-control" name="preciop">
                </div>
                </div>

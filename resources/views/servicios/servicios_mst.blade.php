...
<div class="container size-1/2 m-auto position-relative ">
    ...
    <form class="form-horizontal" action="{{route('servicios.editars', $servicio_actual) }}" method="POST">
        @csrf   
        @method('post')
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type="text" disabled value="{{$servicio_actual->nombre_serv}}" class="form-control text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" name="nombrep">
                </div>
            </div>         
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  ...
                  name="descrp">{{$servicio_actual->descripcion_serv}}</textarea>
                </div>   
              </div>
              <div class="form-group row">
                <label for="text" required class="col-sm-4 col-form-label">Precio:</label>
                <div class="col-sm-6">
                    <input type="number" disabled placeholder="Precio" value="{{$servicio_actual->precio_serv}}"  class="form-control" name="preciop">
                </div>
                </div>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    ...
                    <a href="{{route('servicios.editars', $servicio_actual)}}"<button type="button" class="btn btn-primary"> Editar </button></a>

<div>
    ...
    <div class="container size-1/2 m-auto position-relative ">
        ...
        <form class="form-horizontal" action="{{route('servicios.saves') }}" method="POST">
            @csrf   
            @method('post')
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" required  placeholder="Nombre" class="form-control text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" name="nombres">
                    </div>
                </div>               
                  <div class="form-group row">
                    <label for="text" class="col-sm-4 col-form-label">Descripcion:</label>
                    <div class="col-sm-6">
                      <textarea class="form-control" placeholder="Descripcion del servicio" class="form-control text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" style="height: 180px;"
                      name="descrs"></textarea>
                    </div>   
                  </div>
                  <div class="form-group row">
                    <label for="text" required class="col-sm-4 col-form-label">Precio:</label>
                    <div class="col-sm-6">
                        <input type="number" required  placeholder="10.00" min="0" max="99999"  class="form-control" name="precios">
                    </div>
                    </div>

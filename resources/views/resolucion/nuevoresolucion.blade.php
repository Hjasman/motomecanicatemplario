...
@section('content')
    ...
    <div class="card-body">
        ...
        <div class="mt-3 input-group">
            <span class="input-group-text bg-primary">Solucion:</span>
            <div class="col-sm-6">
                <textarea class="form-control"  placeholder="Solucion" class="form-control text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" style="height: 80px;"
        ...
        <table id="example1" class="table table-striped " style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-md-flex">
                            <a href="{{route('diagnostico.llenadodiag')}}"<button type="button" class="btn-sm btn-warning  ">Resolucion</button></a> 
